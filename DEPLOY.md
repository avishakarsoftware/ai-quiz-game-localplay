...
- Pending next gamma deploy/smoke: broader host-app egress hardening so organizer/player/spectator terminal error states return to Revelry Games instead of exposing standalone LocalPlay picker/join recovery.
