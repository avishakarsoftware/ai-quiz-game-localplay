...
export const LOCAL_GAME_RULES: Partial<Record<GameType, GameRules>> = {
    ...
    impostor: rules('Impostor Rules', 'Everyone answers the same question — except one player, who got a different one.', ['Spot the player whose question was different.', 'If you are the impostor, blend in and survive the vote.'], ['Everyone gets a question on their phone. One is secretly different.', 'Everyone submits a short answer.', 'All answers are revealed and everyone votes for the impostor.', 'The impostor and both questions are revealed.'], ['Guess the impostor correctly: 2 points.', 'Impostor survives without a majority naming them: 3 points.', 'The impostor role rotates so everyone gets a turn.'], { player_count: { min: 3, recommended: '4-10' } }),
