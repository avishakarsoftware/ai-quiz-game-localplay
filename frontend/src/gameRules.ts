...
export const LOCAL_GAME_RULES: Partial<Record<GameType, GameRules>> = {
    ...
    chit_pull: rules('Chit Pull Rules', 'A random player gets a random question, action, or mini challenge.', ['Complete the chit when your name is picked.'], ['The app picks a player and chit.', 'The host marks completed, skipped, or redraw.'], ['Completed chits score points.', 'Highest score wins.'], { player_count: { min: 2, recommended: '4-30' } }),
    mafia: rules('Mafia Rules', 'Find the Mafia before they outnumber the town.', ['Town wins by eliminating all Mafia.', 'Mafia wins when they equal or outnumber Town.'], ['Everyone gets a secret role.', 'Night prompts are private.', 'Daytime discussion ends in a vote.'], ['Eliminated players leave the vote.', 'The game ends when a side reaches its win condition.'], { player_count: { min: 5, recommended: '7-15' }, sections: [{ id: 'privacy', title: 'Keep private', items: ['Do not show your role screen unless the game reveals it.', 'Mafia should coordinate only through private prompts.'] }] }),
