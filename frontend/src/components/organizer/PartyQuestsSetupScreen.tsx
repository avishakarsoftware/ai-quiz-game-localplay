...
export function partyQuestsConfigFromPayload(
    payload: Record<string, unknown>,
    fallbackTitle = 'Party Quests',
): PartyQuestSetupConfig {
    ...
    return {
        ...
        quests_per_player: Math.min(
            Number(raw.quests_per_player) || fallback.quests_per_player,
            Math.max(3, quests.length),
        ),
